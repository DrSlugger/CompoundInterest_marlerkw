 ...
 * Description: The CompoundInterest Class to calculate the compound interest the be accessed my 
...
public class CompoundInterest {
	 ...
	 */
	public CompoundInterest(double principleInvestment, double interestRate, int compoundingsPerPeriod, int numberOfYears) {
